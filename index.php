      ...
      <?php }else{
        ...
        <div class="<?php echo $colunas ?>">
          <div class="contact-widget wow bounceInUp">
            ...
            <p>
              <a target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsapp_sistema ?>" class="link-neutro" style="color:#4d3222ff"><?php echo $telefone_sistema ?></a>
            </p>
          </div>
        </div>
        <div class="<?php echo $colunas ?>">
